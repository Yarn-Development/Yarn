    ...
    exports.execute = async(client, message, args) => {
        ...
        if (!args[0]) return message.channel.send(`${client.emotes.error} - Please indicate the title of a song or a url of a song!`);
        ...
        await queue.metadata.send({ content: `⏱ | Loading your ${searchResult.playlist ? "playlist" : "track"}...` });
