  ...
  .then(info => {
      message.channel.send({embeds:[{
        stats:{
          ...
          timestamp: new Date(),
          fields: [
            { name: 'Owner', value: `[Aspekts](https://twitch.tv/aspekts)`,inline:false },
            ...
            { name: 'Yarn Version', value: client.config.version, inline:true}
          ],
          footer: {name: message.author.tag, value: message.author.displayAvatarURL()}
        },
      }]
    })
   });
