...
exports.execute = async(client, message, args) => {
        ...
        if (userID == lockedList) {
            ...
            if (!bug) {
              ...
              client.channels.cache.get('829432191645646858').send(`${person} of ${message.guild.name} (Guild ID: ${message.guild.id}, User ID: ${userID}) reported the bug: ${bug}`);
