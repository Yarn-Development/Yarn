module.exports = (client, error, message, ...args) => {
    switch (error) {
        ...
        case 'MusicStarting':
            ...
            break;
        default:
            message.channel.send(`${client.emotes.error} - Something went wrong ... Error : ${error} If your music is still playing, ignore this message. If not, contact Aspekts #4616 for help`);
    };
};
